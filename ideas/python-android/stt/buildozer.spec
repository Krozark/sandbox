...
presplash.filename = %(source.dir)s/data/ava-presplash-512.jpg

# (str) Icon of the application
icon.filename = %(source.dir)s/data/ava-128.png
...
#android.add_aars =
# android.add_aars = %(source.dir)s/aar/vosk-android-release.aar
